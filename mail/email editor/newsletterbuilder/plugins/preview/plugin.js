    ...
    _cb.addButton('preview', button_html, '.previewcontent-button', function (e) {
      ...
      for (var i = 0; i < styles.length; i++) {
        if (
          ...
          styles[i].href.indexOf("newsletterbox.css") == -1 &&
          styles[i].href.indexOf("newsletterbuilder.css") == -1
        ) {
          csslinks +=
            '<link href="' +
            styles[i].href +
      ...
      for (var i = 0; i < scripts.length; i++) {
        if (
          ...
          scripts[i].src.indexOf("newsletterbox.js") == -1 &&
          scripts[i].src.indexOf("newsletterbox.min.js") == -1 &&
          scripts[i].src.indexOf("newsletterbuilder.js") == -1 &&
          scripts[i].src.indexOf("newsletterbuilder.min.js") == -1 &&
